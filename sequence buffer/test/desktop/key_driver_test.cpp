...
TEST_F(KEYDriverTest, get_key_not_pressed) {
    ...
    EXPECT_TRUE(get_key(0) != (1<<0));
    EXPECT_TRUE(get_key(1) != (1<<1));
    EXPECT_TRUE(get_key(2) != (1<<2));
    EXPECT_TRUE(get_key(3) != (1<<3));
    EXPECT_TRUE(get_key(4) != (1<<4));
    EXPECT_TRUE(get_key(5) != (1<<5));
}
